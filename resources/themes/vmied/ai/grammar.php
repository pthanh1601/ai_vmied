...
<?= $this->insert('ai/menu-ai',["user"=>$user,'active'=>'grammar']) ?>
            ...
            <div class="col-lg-8 d-flex flex-column bg-white border-end h-100">
                ...
                <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center bg-white">
                    <div class="d-flex align-items-center gap-2">
                        <span class="text-success"><i data-lucide="spell-check" style="width: 20px; height: 20px;"></i></span>
                        <h5 id="workspace-title" class="fw-bold text-dark m-0">Check Ngữ pháp</h5>
                    </div>

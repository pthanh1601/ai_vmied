...
<section class="container py-4" 
    data-page-script="/js/ai.js"
    data-ai-mode="plagiarism" 
    data-ai-endpoint="/app/plagiarism/scan">
            ...
            <div class="col-lg-8 d-flex flex-column bg-white border-end h-100">
                ...
                <div class="px-4 py-3 border-bottom d-flex justify-content-between align-items-center bg-white">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="fw-bold text-dark m-0">Check Đạo văn</h5>
                    </div>
                    <div class="d-flex align-items-center gap-3">
                        <span class="badge bg-light text-secondary border rounded-pill fw-normal px-3 py-2" id="word-count">0 từ</span>
                        <button class="btn btn-link text-secondary p-0 text-decoration-none" title="Xóa" onclick="clearEditor()">
                ...
                <div class="px-4 py-3 border-top d-flex flex-wrap justify-content-between align-items-center gap-3 bg-white">
                    ...
                    <button onclick="runAnalysis()" class="btn btn-dark text-white fw-bold py-2 px-4 rounded-3 d-flex align-items-center gap-2 shadow w-100 w-sm-auto justify-content-center">
                ...
                <div class="p-4 border-bottom">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <div class="bg-white p-3 rounded-3 border shadow-sm">
                            ...
                            <select id="config-lang" class="form-select form-select-sm border-0 bg-transparent shadow-none fw-semibold text-dark p-0">
                ...
                <div class="flex-grow-1 p-4 overflow-auto">
                    ...
                    <div id="result-content" class="d-none d-flex flex-column gap-3">
                        ...
                        <div class="bg-white p-4 rounded-4 border shadow-sm text-center position-relative overflow-hidden">
                            <span class="text-secondary small fw-bold text-uppercase">Tỉ lệ đạo văn</span>
                            <div class="display-5 fw-bold text-dark my-1" id="score-value">0%</div>
                            <div id="score-badge" class="badge fw-bold px-2 py-1 rounded"></div>
                            <div class="position-absolute bottom-0 start-0 w-100" style="height: 4px; background: linear-gradient(to right, #22c55e, #facc15, #f87171);"></div>
                        </div>

                        <div class="bg-white rounded-4 border shadow-sm p-3">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="small fw-bold text-secondary">Nguồn trùng lặp</span>
                                <span class="small fw-bold text-dark" id="match-count">0 nguồn</span>
                            </div>
                            <div id="match-list" class="d-flex flex-column gap-2"></div>
                        </div>

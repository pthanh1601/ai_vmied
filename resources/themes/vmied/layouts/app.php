...
<body>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="mobileSidebar" aria-labelledby="mobileSidebarLabel">
        ...
        <div class="offcanvas-body d-flex flex-column justify-content-between">
            ...
            <div class="d-flex flex-column gap-2 mt-4" hx-boost="true" hx-target="#app-content" hx-select="#app-content" hx-swap="outerHTML show:window:top">
    ...
    <div class="container-fluid p-0 h-100 pt-2" id="app-content">
        <?= $this->yield('content') ?>
    </div>
